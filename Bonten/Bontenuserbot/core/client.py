...
class BontenClient(TelegramClient):
    def cat_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[here](https://t.me/komiXsupport)"
            ...
            from Bontensession import Bontenub
            ...
            if pattern is not None:
                ...
                if edited:
                    Bontenub.add_event_handler(func, events.MessageEdited(**kwargs))
                Bontenub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                Bontenub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                Bontenub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
BontenClient.fast_download_file = download_file
BontenClient.fast_upload_file = upload_file
BontenClient.reload = restart_script
BontenClient.get_msg_link = get_message_link
BontenClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    BontenClient.send_message = send_message
    BontenClient.send_file = send_file
    BontenClient.edit_message = edit_message
